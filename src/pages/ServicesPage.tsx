  ...
  const services = [
    {
      ...
      points: ["Routine eye exams", "Vision testing & prescription updates", "Early detection of eye problems"],
      image: eyeHospital,
    },
    {
      icon: EyeOff,
      ...
      points: ["Cataracts, glaucoma, dry eyes", "Diabetic retinopathy care", "Allergy & infection treatment",],
      image: consultation,
    },
    {
      icon: Wrench,
      ...
      points: ["Cataract surgery", "LASIK / refractive procedures", "Retinal & corneal surgeries"],
      image: heroDoctor,
    },
    {
      icon: AlertCircle,
      ...
      points: ["Treatment for eye injuries", "Care for sudden vision loss", "Removal of foreign bodies"],
      image: medicalTeam,
    },
    {
      icon: Users,
      ...
      points: ["Vision screening", "Amblyopia treatment", "Strabismus management", "Preventive care"],
      image: imageAsset,
    },
    {
      icon: Glasses,
      ...
      points: ["Glasses, frames, lenses", "Contact lens fitting", "Adjustment & repair services"],
      image: doctorsTeam,
    },
  ];
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground">Comprehensive Medical Services</h2>
            <p className="text-foreground/60 mt-4 max-w-2xl mx-auto">
              We provide a full range of medical services from preventive care to specialized treatment. Our team is dedicated to your health and wellbeing.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <Button variant="ghost" className="mt-4 w-full hover:bg-accent/10">
                    Learn More
                  </Button>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-7 order-2 md:order-1">
              <div>
                <p className="text-accent text-sm font-semibold tracking-wider uppercase mb-2">Our Commitment</p>
                <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Quality Healthcare for Everyone</h2>
              </div>

              <div className="space-y-4">
                <p className="text-foreground/80 leading-relaxed">
                  We believe that quality healthcare should be accessible to everyone. Our mission is to provide compassionate, comprehensive medical services that improve the health and well-being of our community.
                </p>
                <p className="text-foreground/80 leading-relaxed">
                  With a team of experienced doctors and state-of-the-art facilities, we are committed to delivering the highest standard of medical care to all our patients.
                </p>
              </div>
            </div>
