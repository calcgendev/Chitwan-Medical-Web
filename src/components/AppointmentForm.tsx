...
import consultation from "@/assets/image2.jpeg";

const AppointmentForm = () => {
  return (
    <section
      className="relative py-20 min-h-[320px] md:min-h-[520px]"
      id="book-appointment"
    >
      ...
      />
      <div
        className="absolute inset-0 bg-black/5 md:bg-black/20"
        aria-hidden={true}
      />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="max-w-md">
              ...
              <p className="text-black">
                Fill out the form and our staff will contact you within 24 hours
                      ...
                      <div className="p-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mt-4">
                          <div>
                            ...
                            <Input
                              id="date"
                              type="date"
                              className="bg-transparent border-b border-white/20 text-white rounded-none"
                            />
                          </div>
                          <div>
                        ...
                        <div className="mt-4">
                          ...
                          <Textarea
                            ...
                            className="bg-transparent border-b border-white/20 text-white placeholder:text-white/60 min-h-24 rounded-none"
                          />
                        </div>
                      </div>
                    </div>
