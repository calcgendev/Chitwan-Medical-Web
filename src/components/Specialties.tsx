...
const Specialties = () => {
  const specialties = [
    { icon: Eye, name: "General Ophthalmology" },
    { icon: ScanEye, name: "Cataract Surgery" },
    { icon: ShieldPlus, name: "Glaucoma Care" },
    { icon: Droplets, name: "Retina & Vitreous" },
    { icon: Glasses, name: "Refractive Surgery" },
    { icon: Baby, name: "Pediatric Eye Care" },
    { icon: Microscope, name: "Eye Diagnostics" },
    { icon: Store, name: "Optical & Pharmacy" },
  ];
