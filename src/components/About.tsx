    ...
    <section className="py-20 bg-background" id="about">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <p className="text-accent text-sm font-semibold tracking-wider uppercase mb-2">Welcome to medical</p>
          ...
          <Button variant="link" className="mt-4 text-accent">Learn More →</Button>
        </div>
